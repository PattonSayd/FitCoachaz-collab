...
import 'package:fitcoachaz/app/assemble/assemble_module.dart' as _i20;
import 'package:fitcoachaz/data/services/firebase_auth_service.dart' as _i3;
import 'package:fitcoachaz/data/services/firebase_storage_service.dart' as _i4;
import 'package:fitcoachaz/data/services/firestore_service.dart' as _i5;
...
import 'package:fitcoachaz/ui/bloc/congratulation/congratulation_bloc.dart'
    as _i18;
import 'package:fitcoachaz/ui/bloc/email/email_bloc.dart' as _i19;
import 'package:fitcoachaz/ui/bloc/main/main_bloc.dart' as _i14;
import 'package:fitcoachaz/ui/bloc/register/register_bloc.dart' as _i15;
import 'package:fitcoachaz/ui/bloc/session/session_bloc.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i4.FirebaseStorageService>(
        () => assembleModule.providerFirebaseStorageService());
    gh.factory<_i5.FirestoreService>(
        () => assembleModule.providerFirestoreService());
    await gh.singletonAsync<_i6.KeyValueStore>(
      () => assembleModule.providerKeyValueStore(),
      preResolve: true,
    );
    gh.factory<_i7.MainRepository>(() => assembleModule.providerMainRepository(
          gh<_i5.FirestoreService>(),
          gh<_i4.FirebaseStorageService>(),
        ));
    gh.factory<_i8.RegisterRepository>(
        () => assembleModule.providerRegisterRepo(
              gh<_i6.KeyValueStore>(),
              gh<_i5.FirestoreService>(),
              gh<_i3.FirebaseAuthService>(),
            ));
    gh.factory<_i9.SessionRepository>(
    ...
    gh.lazySingleton<_i14.MainBloc>(
    ...
    gh.factory<_i18.CongratulationBloc>(() => assembleModule
        .providerCongratulationBloc(gh<_i12.CongratulationRepository>()));
    gh.factory<_i19.EmailBloc>(
        () => assembleModule.providerEmailBloc(gh<_i13.EmailRepository>()));
    return this;
  }
}

class _$AssembleModule extends _i20.AssembleModule {}
