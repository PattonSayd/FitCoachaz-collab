...
import 'package:fitcoachaz/domain/repositories/congratulation_repository.dart'
    as _i10;
import 'package:fitcoachaz/domain/repositories/email_repository.dart' as _i11;
import 'package:fitcoachaz/domain/repositories/register_repository.dart' as _i6;
import 'package:fitcoachaz/domain/repositories/session_repository.dart' as _i7;
...
import 'package:fitcoachaz/ui/bloc/session/session_bloc.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i7.SessionRepository>(() => assembleModule.providerSessionRepo(
          gh<_i5.KeyValueStore>(),
          gh<_i4.FirestoreService>(),
          gh<_i3.FirebaseAuthService>(),
        ));
    ...
    gh.factory<_i10.CongratulationRepository>(
    ...
    gh.factory<_i13.SessionBloc>(
        () => assembleModule.providerSessionBloc(gh<_i7.SessionRepository>()));
